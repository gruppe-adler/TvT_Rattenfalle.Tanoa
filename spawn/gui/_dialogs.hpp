...
class gui_spawn_pilot
{
		...
		class ControlsBackground
		{
			class gui_spawn_pilot_bg: background
			{
				idc = 8011;
		...
		class Controls {
			...
			class text_spawn_pilot1: RscStructuredText
			{
				idc = -1;
				text = "<t align='center' size='1.2'>Hello Pilot!</t>";
			...
			class text_spawn_pilot2: RscStructuredText
			{
				idc = -1;
			...
			class btn_spawn_pilot3: RscButton
			{
				idc = -1;
