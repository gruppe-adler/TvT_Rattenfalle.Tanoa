...
_tempRussian_1 = (mudschahedinSupplies select 1);
_tempRussian_2 = (mudschahedinSupplies select 2);
_tempRussian_3 = (mudschahedinSupplies select 3);
_tempRussian_4 = (mudschahedinSupplies select 4);
_tempRussian_5 = (mudschahedinSupplies select 5);
...
switch (_selector) do {
    ...
    case 1: { _tempMudschahedin_1 = [_idc,_tempMudschahedin_1] call calculateVehicleCall; };
    case 2: { _tempMudschahedin_2 = [_idc,_tempMudschahedin_2] call calculateVehicleCall; };
    case 3: { _tempMudschahedin_3 = [_idc,_tempMudschahedin_3] call calculateVehicleCall; };
    case 4: { _tempMudschahedin_4 = [_idc,_tempMudschahedin_4] call calculateVehicleCall; };
    case 4: { _tempMudschahedin_5 = [_idc,_tempMudschahedin_5] call calculateVehicleCall; };
